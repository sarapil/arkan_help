...
```bash
bench --site dev.localhost get-untranslated ar --app arkan_help
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `arkan_help/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app arkan_help | wc -l
```
...
2. Edit/create the CSV file in `arkan_help/translations/`
