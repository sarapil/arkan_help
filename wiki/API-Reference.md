...
All Arkan Help APIs follow the Arkan Lab API standards.

## Base URL — الرابط الأساسي

```
POST /api/method/arkan_help.api.v1.<module>.<function>
```
...
```bash
curl -X POST 'https://site.example.com/api/method/arkan_help.api.v1.records.get_list' \
