...
Arkan Help follows the Arkan Lab architecture standards built on Frappe v16.
...
class MyDocType(Document):
    def validate(self):
        from arkan_help.services.my_service import MyService
...
```python
from arkan_help.api.response import success, error, paginated
