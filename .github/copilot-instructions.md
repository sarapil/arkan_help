# Arkan Help — AI Copilot Instructions

## Overview

**Arkan Help** (arkan_help) is an Arkan Lab Frappe v16 application.
Contextual help system with guided tutorials for Frappe
...
All DocTypes use the `AR_` prefix to avoid conflicts.
