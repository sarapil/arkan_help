...
"""
Arkan Help — Demo Data
Load/clear demo data for Arkan Help showcases.
...
def load_demo_data():
    """Load demonstration data for Arkan Help.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for Arkan Help"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for Arkan Help"))
