...
# CODESPACES: app_include_js = ["/assets/arkan_help/js/arkan_help_combined.js"]

# CODESPACES: app_include_css = ["/assets/arkan_help/css/arkan_help_combined.css"]
...
# ─── Post-Migration Seed ───
after_migrate = ["arkan_help.seed.seed_data"]
