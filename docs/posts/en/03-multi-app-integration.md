...
# 🔗 Arkan Help + ERPNext Ecosystem: Better Together

> **How Arkan Help integrates with ERPNext and other Arkan Lab apps to create a complete business solution**

---

## The Power of Integration

Arkan Help doesn't work in isolation. It's designed to be part of a **connected ecosystem**:
...
4. **Project started** with full tracking (Arkan Help manages the details)
...
# Your industry app
bench get-app arkan_help

# Communication layer
bench get-app arrowz

# Install all
bench --site your-site install-app caps frappe_visual arkan_help arkan_help arrowz
```
